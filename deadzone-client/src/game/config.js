...
export const WEAPONS = {
  rifle: { name: 'Auto Rifle', tag: 'Climbing recoil', unlockLevel: 1, damage: 16, speed: 1.2, cooldown: 120, pellets: 1, spread: 0.026, color: '#79c9ff', magazineSize: 30, reloadTime: 1450, recoilPitch: 0.042, recoilYaw: 0.038, recoilRecovery: 0.018 },
  ...
  smg: { name: 'SMG', tag: 'Wild spray', unlockLevel: 3, damage: 10, speed: 1.25, cooldown: 80, pellets: 1, spread: 0.04, color: '#bdfbff', magazineSize: 40, reloadTime: 1300, recoilPitch: 0.032, recoilYaw: 0.048, recoilRecovery: 0.022 },
  ...
  rpg: { name: 'RPG', tag: 'Heavy blast', unlockLevel: 7, damage: 74, speed: 0.62, cooldown: 950, pellets: 1, spread: 0.012, color: '#ff884d', magazineSize: 1, reloadTime: 3200, recoilPitch: 0.12, recoilYaw: 0.03, recoilRecovery: 0.012, explosiveRadius: 7.5 },
};

export const OUTFITS = [
  { id: 'classic', name: 'Classic Shell', shell: '#f3f7ff', trim: '#cbd8ea', price: 0 },
  { id: 'shadow', name: 'Shadow Ops', shell: '#2f3746', trim: '#7b88a0', price: 40 },
  { id: 'neon', name: 'Neon Runner', shell: '#faf7ff', trim: '#ff5fd2', price: 65 },
  { id: 'forest', name: 'Forest Guard', shell: '#e8ffe7', trim: '#62e86b', price: 85 },
  { id: 'gold', name: 'Gold Unit', shell: '#fff1b7', trim: '#f5a524', price: 120 },
  { id: 'lava', name: 'Lava Core', shell: '#211513', trim: '#ff5b2e', price: 160 },
  { id: 'knight', name: 'Castle Knight', shell: '#dce4ed', trim: '#7d8a99', price: 140 },
  { id: 'striker', name: 'Pitch Striker', shell: '#f7fff3', trim: '#38d16a', price: 110 },
];

export const WEAPON_SKINS = [
  { id: 'standard', name: 'Standard Steel', color: '#cbd8ea', price: 0 },
  { id: 'ember', name: 'Ember Barrel', color: '#ff7a3d', price: 55 },
  { id: 'arctic', name: 'Arctic Chrome', color: '#9cf7ff', price: 70 },
  { id: 'toxic', name: 'Toxic Glow', color: '#78ff73', price: 90 },
  { id: 'royal', name: 'Royal Guard', color: '#d8b4ff', price: 120 },
  { id: 'goldline', name: 'Goldline', color: '#f5c84b', price: 160 },
];
