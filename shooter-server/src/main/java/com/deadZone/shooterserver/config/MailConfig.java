...
public class MailConfig {
    ...
    public JavaMailSender javaMailSender(
            ...
            @Value("${spring.mail.properties.mail.smtp.connectiontimeout:20000}") String connectionTimeout,
            @Value("${spring.mail.properties.mail.smtp.timeout:20000}") String timeout,
            @Value("${spring.mail.properties.mail.smtp.writetimeout:20000}") String writeTimeout
    ) {
